...
## Defense Checklist — Week 14

### Before Pre-defense (ASAP)
- [ ] GitHub repo created
- [ ] README.md added (project description + team members)
- [ ] Angular project initialized (`ng new`) and pushed
- [ ] Teacher informed: members, project name, GitHub link

### Defense Day
- [ ] 5–7 min live demo presentation
- [ ] Q&A with teacher
